...
class TranslateFunction extends Doctrine\ORM\Query\AST\Functions\FunctionNode {
    ...
    {
        return "TRANSLATE(".$sqlWalker->walkSimpleArithmeticExpression($this->stringPrimary). ", 

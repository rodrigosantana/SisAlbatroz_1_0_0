        ...
        <div class="row ">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-8 div-help">
                        <input type="number" step="any" class="form-control" id="dado_abiotico_<?php echo $numero; ?>_<?php echo $nome; ?>_fim_temperatura_ar" name="dado_abiotico[<?php echo $numero; ?>][<?php echo $nome; ?>][fim][temperatura_ar]" value="<?php echo $objeto->getTemperaturaArFim() ?>">
                    </div>
                </div>
            </div>
        </div>
        <div class="row ">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-8 div-help">
                        <input type="number" step="any" class="form-control" id="dado_abiotico_<?php echo $numero; ?>_<?php echo $nome; ?>_fim_temperatura_sup_mar" name="dado_abiotico[<?php echo $numero; ?>][<?php echo $nome; ?>][fim][temperatura_sup_mar]" value="<?php echo $objeto->getTemperaturaSupMarFim() ?>">
                    </div>
                </div>
            </div>
        </div>

<form class="form-horizontal" role="form" action="<?php echo site_url('observadorbordo/filter'); ?>" method="post">
                        ...
                        <div class="col-md-8 div-help">
                            <select class="select2" id="observador" name="observador" style="width: 100%">
                                ...
                                <?php foreach ($observadores as $observador): ?>
                                    <?php $selected = (!empty($filtro['observador']) && (int)$filtro['observador'] == $observador->getIdObserv()) ? 'selected' : '' ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <a href="<?php echo site_url('observadorbordo/clearfilter')?>" class="btn btn-default btn_sub pull-right">Limpar filtro</a>

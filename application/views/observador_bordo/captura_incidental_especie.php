...
<div class="row captura-incidental-especie">
    <div class="col-md-7 insertaction">
        <div class="form-group">
            <label for="captura_incidental_<?php echo $numero; ?>_ci_especie_<?php echo $numero2?>_especie" class="col-md-3 control-label">Espécie</label>
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label for="captura_incidental_<?php echo $numero; ?>_ci_especie_<?php echo $numero2?>_etiqueta" class="col-md-3 control-label">Etiqueta</label>
            <div class="col-md-9 div-help">

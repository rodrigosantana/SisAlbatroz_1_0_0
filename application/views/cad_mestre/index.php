...
<div class="panel panel-sisalbatroz">
    <div class="panel-heading" style="height: 55px">
        ...
        <a href="<?php echo site_url('cad_mestre_ct/novo') ?>" class="btn btn-add-sisalbatroz pull-right"><i class="glyphicon glyphicon-plus"></i> Adicionar</a>
        <?php endif;?>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-condensed table-hover">
                ...
                <tbody>
                    ...
                    <?php foreach ($lista as $mestre): ?>
                        <tr>

                            <td class="text-center"> <?php echo $mestre->getNome() ?> </td>
                            <td class="text-center"> <?php echo $mestre->getApelido() ?> </td>
                            <td class="text-center"> <?php echo $mestre->getTelefone() ?> </td>
                            <td class="text-center"> <?php echo $mestre->getEmail() ?> </td>
    ...
    <div class="modal-dialog" style="width: 750px">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Filtro de Mestres</h4>
            </div>
